...
interface RecentFileTableProps {
...
export default function RecentFileTable({ onFileClick }: RecentFileTableProps) {
  return (
                ...
                <tr
                    ...
                    onClick={() =>
                        onFileClick({
                          ...
                          title: row.fileName,
                          usage: row.category,
                          fileCount: 1, // You can adjust this if you have multiple files in a folder
                          storageUsed: row.size,
                          iconStyle: "bg-blue-100 text-blue-500", // or derive based on category
                        })
                    }
                >
